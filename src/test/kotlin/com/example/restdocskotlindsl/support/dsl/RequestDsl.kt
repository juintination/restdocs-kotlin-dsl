...
class RequestDsl {
    ...
    internal fun buildRequestBuilder(): MockHttpServletRequestBuilder {
    ...
    private fun buildStandardRequest(pathVars: Array<Any>): MockHttpServletRequestBuilder {
    ...
    private fun buildFormRequest(pathVars: Array<Any>): MockHttpServletRequestBuilder {
        val builder = when (method) {
            HttpMethod.GET -> RestDocumentationRequestBuilders.get(urlTemplate, *pathVars)
            HttpMethod.POST -> RestDocumentationRequestBuilders.post(urlTemplate, *pathVars)
            HttpMethod.PUT -> RestDocumentationRequestBuilders.put(urlTemplate, *pathVars)
